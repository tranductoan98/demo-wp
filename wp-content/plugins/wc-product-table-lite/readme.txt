...
Tags: woocommerce product table, wc product table, product table for woocommerce, woocommerce table view, woocommerce product tables, woocommerce tables, woocommerce product table layout, product table for wc, woocommerce product list, product list for woocommerce, woocommerce list
...
= 2.4.1 (27th September '21) =

Fixed
* Text and HTML element error


= 2.4.0 (24th September '21) =

Lite version specific enhancements:
...
* Styling options for navigation section
...
* Floating save settings button for convenience 
* Extended list of compatible tab and accordion plugins and page builders
* Search though column elements for convenience, also alphabetical order
...
* Control which pages show cart widget 

Fixed
* Compatibility with The Events Calendar plugin
* Search returning no results issue


Dozens of PRO version enhancements listed below:
