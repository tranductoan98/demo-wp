...
if (!class_exists('WWP_Dashboard')) {
    ...
    class WWP_Dashboard
    {
         ...
         * @access private
         */
        private $wwpp_plugin_path = WP_PLUGIN_DIR . DIRECTORY_SEPARATOR . 'woocommerce-wholesale-prices-premium' . DIRECTORY_SEPARATOR . 'woocommerce-wholesale-prices-premium.bootstrap.php';
         ...
         * @access private
         */
        private $wwof_plugin_path = WP_PLUGIN_DIR . DIRECTORY_SEPARATOR . 'woocommerce-wholesale-order-form' . DIRECTORY_SEPARATOR . 'woocommerce-wholesale-order-form.bootstrap.php';
         ...
         * @access private
         */
        private $wwlc_plugin_path = WP_PLUGIN_DIR . DIRECTORY_SEPARATOR . 'woocommerce-wholesale-lead-capture' . DIRECTORY_SEPARATOR . 'woocommerce-wholesale-lead-capture.bootstrap.php';
        ...
        public function __construct($dependencies)
        {
            ...
            $this->wholesale_users_ids = $this->_wwp_wholesale_roles->get_all_wholesale_user_ids();
        ...
        public function load_back_end_styles_and_scripts($handle)
        {
            ...
            if ($handle === 'toplevel_page_wholesale-suite') {
        ...
        public function get_total_wholesale_orders($days_filter = '30')
        {
            ...
            $cache = get_transient('wwp_total_wholesale_orders_cache');
            ...
            set_transient('wwp_total_wholesale_orders_cache', $total_wholesale_orders, MINUTE_IN_SECONDS);
        ...
        public function get_total_wholesale_revenue($days_filter = '30')
        {
            ...
            $cache = get_transient('wwp_total_wholesale_revenue_cache');
            ...
            set_transient('wwp_total_wholesale_revenue_cache', $total_revenue, WEEK_IN_SECONDS);
        ...
        public function get_top_wholesale_customers()
        {
            ...
            $cache = get_transient('wwp_top_wholesale_customers_cache');
            ...
            foreach ($this->wholesale_users_ids as $user_id) {
            ...
            // Store as cache. Cache expires in 1 week.
            set_transient('wwp_top_wholesale_customers_cache', $wholesale_spent, WEEK_IN_SECONDS);
        ...
        public function get_recent_wholesale_orders()
        {
            ...
            $cache = get_transient('wwp_recent_wholesale_orders_cache');
            ...
            // Store as cache. Cache expires in 1 week.
            set_transient('wwp_recent_wholesale_orders_cache', $wholesale_orders, WEEK_IN_SECONDS);
        ...
        public function get_wws_plugins_license_statuses($recheck_plugin_status = false)
        {
            ...
            // Use the cache
            $cache = get_transient('wwp_plugin_license_statuses_cache');
            ...
            set_transient('wwp_plugin_license_statuses_cache', $wws_license_statuses, DAY_IN_SECONDS);
        ...
        public function clear_cache()
        {
            ...
            delete_transient('wwp_total_wholesale_orders_cache');

            // Total wholesale revenue cache
            delete_transient('wwp_total_wholesale_revenue_cache');

            // Top wholesale customers cache
            delete_transient('wwp_top_wholesale_customers_cache');

            // Recent wholesale orders cache
            delete_transient('wwp_recent_wholesale_orders_cache');
        ...
        public function activate_plugin($plugin_name)
        {
            ...
            switch ($plugin_name) {
                case 'wwof':
                    $plugin_path = $this->wwof_plugin_path;
                    break;
                case 'wwlc':
                    $plugin_path = $this->wwlc_plugin_path;
                    break;
                default:
                    $plugin_path = $this->wwpp_plugin_path;
            }
        ...
        public function clear_license_cache_on_version_check($result, $activation_email, $license_key)
        {
            ...
            delete_transient('wwp_plugin_license_statuses_cache');
        ...
        public function run()
        {
            ...
            register_activation_hook($this->wwpp_plugin_path, array($this, 'clear_license_cache_on_activation_deactivation'));
            register_activation_hook($this->wwof_plugin_path, array($this, 'clear_license_cache_on_activation_deactivation'));
            register_activation_hook($this->wwlc_plugin_path, array($this, 'clear_license_cache_on_activation_deactivation'));

            // Update license cache on wws plugin deactivation
            register_deactivation_hook($this->wwpp_plugin_path, array($this, 'clear_license_cache_on_activation_deactivation'));
            register_deactivation_hook($this->wwof_plugin_path, array($this, 'clear_license_cache_on_activation_deactivation'));
            register_deactivation_hook($this->wwlc_plugin_path, array($this, 'clear_license_cache_on_activation_deactivation'));
