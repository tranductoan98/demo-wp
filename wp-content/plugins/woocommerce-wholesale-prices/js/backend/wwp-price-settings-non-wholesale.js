jQuery(document).ready(function ($) {
    ...
    function render_show_wholesale_price_to_non_wholesales() {
        ...
        var control_container =
            ...
            "<td class='forminp forminp-password' style='padding-right:0;'>" +
            "<button id='wwp_auto_generate_api_key' name='wwp_auto_generate_api_key' class='button button-secondary'>"+ Options.i18n_auto_generate_key +"</button>" +
    ...
    function run_events() {
        ...
        if(Options.is_api_key_valid){
            ...
            $("body").find("button#wwp_auto_generate_api_key").hide();
        }else {
